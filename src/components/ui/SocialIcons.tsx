...
const socials = [
    {
        name: "GitHub",
        href: "https://github.com/NimeshBabu",
        icon: (
    ...
    {
        name: "WhatsApp",
        href: "https://wa.me/9779862144339",
        icon: (
            <svg viewBox="0 0 24 24" fill="currentColor" className="size-[18px]">
    ...
    {
        name: "Facebook",
        href: "https://www.facebook.com/nimesh.thapa.1221/",
        icon: (
            <svg viewBox="0 0 24 24" fill="currentColor" className="size-[18px]">
                <path d="M22.676 0H1.324C.593 0 0 .593 0 1.324v21.352C0 23.407.593 24 1.324 24h11.495v-9.294H9.691v-3.622h3.128V8.413c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.463.099 2.794.143v3.24h-1.918c-1.505 0-1.796.716-1.796 1.764v2.313h3.587l-.467 3.622h-3.12V24h6.116C23.407 24 24 23.407 24 22.676V1.324C24 .593 23.407 0 22.676 0z" />
            </svg>
        ),
    },
    {
        name: "Instagram",
        href: "https://www.instagram.com/nimesh_thapa_21/",
        icon: (
            <svg viewBox="0 0 24 24" fill="currentColor" className="size-[18px]">
    ...
    {
        name: "LinkedIn",
        href: "https://www.linkedin.com/in/nimesh-thapa-7809b03aa/",
        icon: (
            <svg viewBox="0 0 24 24" fill="currentColor" className="size-[18px]">
    ...
    {
        name: "Dribbble",
        href: "https://dribbble.com/nimesh12",
        icon: (
            <svg viewBox="0 0 24 24" fill="currentColor" className="size-[18px]">
